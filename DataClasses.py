...
# TNord,9.2.2022,Fixed typo in employee.ID.setter
# TNord,9.4.2022,Fixed typo in employee ID attribute
#                Added error handling to attribute setting
# ---------------------------------------------------------- #
...
class Person(object):  # Inherits from object
    ...
    changelog: (When,Who,What)
        ...
        TNord,9.4.2022,Added error handling to attribute setting
    """
...
class Employee(Person):  # Inherits from Person
    ...
    def employee_id(self, value):
        if str(value).isnumeric():
            ...
            raise Exception("IDs must be numbers") # raise ValueError
